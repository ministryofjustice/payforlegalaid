...
This is an API that:
- gets financial reports data from the MOJFIN database in the modernisation platform and returns it to the user in the form of a CSV or Excel data stream
- allows access to reports generated by the [Data Claims Reporting Service (DCRS)](https://github.com/ministryofjustice/laa-data-claims-reporting-service) using data from Data Stewardship, in the form of a pre-generated CSV file.
