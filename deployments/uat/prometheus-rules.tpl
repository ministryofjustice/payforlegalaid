  ...
  groups:
    - name: secretmanager-rules
      ...
      - alert: SecretsManagerPutSecretValue
        expr: secretsmanager_put_secret_value_sum{exported_job="secretsmanager", secret_id="arn:aws:secretsmanager:eu-west-2:754256621582:secret:live-laa-get-payments-finance-data-uat-12224e107affb6aa-nPlhcC"} > 0
        for: 1m
        labels:
