...
public class ReportWorkbook extends SXSSFWorkbook implements Workbook {
    ...
    private void registerMapping(SXSSFSheet sxSheet, XSSFSheet xSheet) {
        updateSheetMapping(SX_FROM_X_FIELD_REF, sxSheet, xSheet);
        updateSheetMapping(X_FROM_SX_FIELD_REF, xSheet, sxSheet);
    }
    ...
    private <K, V> void updateSheetMapping(Field field, K key, V value) {
        try {
