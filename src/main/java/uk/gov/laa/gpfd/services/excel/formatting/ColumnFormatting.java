 ...
 * {@link ExcelMappingProjection#getColumnWidth()} value. This strategy is specifically designed to adjust
 * column widths dynamically.
 */
public interface ColumnFormatting extends Formatting {

    /**
     * Applies the column width specified in the {@link ExcelMappingProjection} to the column containing the
     ...
     * @param fieldAttribute the {@link ExcelMappingProjection} that define the column width for the cell's column
     */
    @Override
