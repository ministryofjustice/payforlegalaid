 ...
 * in a {@link Sheet} based on the provided {@link ExcelMappingProjection}. It provides a mechanism to customize
...
public interface CellFormatter {
    ...
    /**
     * Applies formatting to the specified {@link Cell} based on the provided {@link ExcelMappingProjection}.
     ...
     */
    void applyFormatting(Sheet sheet, Cell cell, ExcelMappingProjection fieldAttribute);
     ...
     * @param fieldAttribute the {@link ExcelMappingProjection} that define the formatting rules for the cell
     */
    default void applyFormatting(Collection<Formatting> formatting, Sheet sheet, Cell cell, ExcelMappingProjection fieldAttribute) {
