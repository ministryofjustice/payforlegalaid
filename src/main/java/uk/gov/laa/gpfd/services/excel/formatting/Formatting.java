 ...
 * formatting to a {@link Cell} in a {@link Sheet} based on the provided {@link ExcelMappingProjection}. It serves as
...
public interface Formatting {
     ...
     * {@link ExcelMappingProjection}. This method defines the core logic for customizing the appearance or behavior
     * of the cell.
     *
     ...
     */
    void apply(Sheet sheet, Cell cell, ExcelMappingProjection fieldAttribute);
}
