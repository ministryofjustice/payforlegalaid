...
public class ReportTrackingTableModel {
    ...
    //The id field is only used for reads from the tracking table, not for writing to it, since the id primary key is auto-incremented in the tracking table, using an oracle DB sequence
    private int id;
