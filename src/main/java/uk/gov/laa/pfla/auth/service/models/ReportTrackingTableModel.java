...
/**
 * A class representing the data in the MOJFIN 'Report Tracking' Table. A subset of this data will eventually be
 * returned to the user via the /report endpoint, in the form of a ReportResponse
 */
@Data
